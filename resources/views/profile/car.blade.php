                        ...
                        <form action="{{ route('car.save') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea name="description" rows="5" class="form-control">{{ old('description', $car->description ?? '') }}</textarea>
                                </div>
                            </div>

                            <div class="text-center mt-3">
                                <button class="btn btn-primary px-5 mr-2">
                                    <i class="fa fa-save"></i> Save Car
                                </button>
                                <a href="{{ route('profile.edit') }}" class="btn btn-secondary px-5">
                                    Back
                                </a>
                            </div>
                        </form>
...
@cannot(isset($car) ? 'cars.edit' : 'cars.create')
<div class="container mt-5">
    <div class="alert alert-danger">
        You do not have permission to {{ isset($car) ? 'edit this car' : 'add a car' }}.
    </div>
</div>
@endcannot
