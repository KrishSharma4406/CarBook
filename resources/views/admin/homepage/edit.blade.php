                ...
                <form action="{{ route('admin.homepage.update') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if($home->hero_background)
                                            <small class="text-muted mt-1 d-block">
                                                Current: <a href="{{ asset($home->hero_background) }}"
                                                    target="_blank">{{ basename($home->hero_background) }}</a>
                                            </small>
                                        @endif
                                    </div>
                                </div>
                    ...
                    <div class="card card-warning">
                        <div class="card-header text-white" style="background-color: #ffc107;">
                            <h3 class="card-title"><i class="fas fa-road mr-2" style="color: #fff;"></i>Rent Steps Section
                                (Better Way to Rent)</h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="rent_title" id="rent_title" class="form-control"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="rent_button_url" id="rent_button_url" class="form-control"
                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="about_subtitle" id="about_subtitle" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="about_description" id="about_description" rows="4" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" name="about_image" id="about_image" class="custom-file-input"
                                            accept="image/*">
                                ...
                                @if($home->about_image)
                                    <small class="text-muted mt-1 d-block">
                                        Current: <a href="{{ asset($home->about_image) }}"
                                            target="_blank">{{ basename($home->about_image) }}</a>
                                    </small>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cta_button_url" id="cta_button_url" class="form-control"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        @if($home->cta_background)
                                            <small class="text-muted mt-1 d-block">
                                                Current: <a href="{{ asset($home->cta_background) }}"
                                                    target="_blank">{{ basename($home->cta_background) }}</a>
                                            </small>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="card card-olive">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="blog_subtitle" id="blog_subtitle" class="form-control"
                                ...
                                @for($i = 1; $i <= 4; $i++)
                                    <div class="col-md-3">
                                        <div class="card bg-light">
                                            ...
                                            <div class="card-body py-2">
                                                <div class="form-group mb-2">
                                                    <label>Number <span class="badge badge-info font-weight-normal"
                                                            style="font-size: 10px;">Auto-calculated</span></label>
