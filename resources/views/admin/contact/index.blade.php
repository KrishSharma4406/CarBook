        ...
        <div class="container-fluid">
            ...
            @if(!$contact)
                <div class="alert alert-warning">
                    ...
                    No contact page data found. Click the button below to set up your contact page.
                </div>
                <a href="{{ route('admin.contact.edit') }}" class="btn btn-primary btn-lg">
                    <i class="fas fa-plus mr-2"></i>Set Up Contact Page
                </a>
            @else
                <div class="mb-3">
                    <a href="{{ route('admin.contact.edit') }}" class="btn btn-primary">
                        <i class="fas fa-edit mr-2"></i>Edit Contact Page
                    </a>
                    <a href="{{ url('/contact') }}" target="_blank" class="btn btn-outline-info ml-2">
                            ...
                            <div class="col-md-8">
                                <table class="table table-bordered table-sm">
                                    <tr>
                                        ...
                                        <td>{{ $contact->hero_title }}</td>
                                    </tr>
                                </table>
                            </div>
                            <div class="col-md-4">
                                @if($contact->hero_background)
                                    <img src="{{ asset($contact->hero_background) }}" class="img-fluid rounded" alt="Hero BG" style="max-height: 150px;">
                                @else
                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-sm">
                            <tr>
                                ...
                                <td>{{ $contact->contact_subtitle ?? 'Not set' }}</td>
                            </tr>
                            <tr>
                                <th>Title</th>
                                <td>{{ $contact->contact_title ?? 'Not set' }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-sm">
                            <tr>
                                ...
                                <td>{{ $contact->contact_address ?? 'Not set' }}</td>
                            </tr>
                            <tr>
                                <th>Phone</th>
                                <td>{{ $contact->contact_phone ?? 'Not set' }}</td>
                            </tr>
                            <tr>
                                <th>Email</th>
                                <td>{{ $contact->contact_email ?? 'Not set' }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
