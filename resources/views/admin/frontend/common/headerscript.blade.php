<!-- Google Font: Source Sans Pro -->
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{ asset('UI/admin/plugins/ionicons/css/ionicons.min.css') }}">
  <!-- Tempusdominus Bootstrap 4 -->
  <link rel="stylesheet" href="{{ asset('UI/admin/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
  <!-- iCheck -->
